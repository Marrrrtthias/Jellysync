...
if [[ "$sonarr_eventtype" = "Download" || "$sonarr_eventtype" = "Rename" || "$sonarr_eventtype" = "EpisodeFileDelete" || "$sonarr_eventtype" = "SeriesDelete" || "$sonarr_eventtype" = "EpisodeFileDelete" ]]; then
    rm -f /jellysync/*.sync
